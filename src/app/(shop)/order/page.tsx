...
const statusClasses: Record<string, string> = {
    ...
    CANCELLED: "bg-error-container/10 text-destructive ring-1 ring-destructive/20 opacity-70",
};
...
export default async function OrdersPage() {
    ...
    return (
        <div className="mx-auto max-w-md px-6 pb-32 pt-8 lg:max-w-[1280px] lg:px-12">
            <div className="mb-8">
                <h1 className="mb-2 text-4xl font-black tracking-tighter text-neutral-50">
                    Order History
                </h1>
            ...
            {result.items.length === 0 ? (
                <section className="flex flex-col items-center rounded-3xl border border-outline-variant/10 py-12 text-center">
                    ...
                    <Button variant="outline" asChild className="rounded-full px-8 py-3 text-xs uppercase tracking-widest text-primary">
            ...
            <div className="mt-12 rounded-[12px] border border-outline-variant/10 bg-gradient-to-br from-primary-container/20 to-transparent p-6">
                ...
                <Button variant="secondary" className="w-full bg-primary text-on-primary hover:scale-[1.02]">
                    Contact Support
                </Button>
            </div>
        </div>
